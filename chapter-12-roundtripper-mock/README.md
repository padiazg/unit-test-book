...
Real-world example: `jokes/internal/adapters/secondary/external/joke_client.go:27` — `jokeAPI` uses `*http.Client` directly; tests inject a mock `http.RoundTripper`.
